...
while($row = mysqli_fetch_assoc($result)){
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        echo 'Course found: '.$course_name.'<br>';
        
    }
}
if(mysqli_num_rows($result) < 1){
    echo '<br><br><div class="container border w-75">Nothing to see here, you are not registered, come back later after you register</div>';
}
?>
    </body>
    </html>